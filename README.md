	    ...
	    <section>
		 <div id="Adchievements">
		   ...
		   <section>
			<div id="about_me">
				<h3>More About Me</h3>
				<p>I was born in monsterrado county Monrovia Liberia. I grew up in Caldwell New Georgia North Road with my grand mother.</P>

			</div>
		   </section>
		   <section>
		 	<div id="footer">
				<p><img src="http://www.intro-webdesign.com/images/newlogo.png" alt="intro-webdesign-img"> This website was created by Elijah C. Duffueah &amp; colleen Van Lent. To learn more about web design, visit <a href="http://www.intro-webdesign.com">Intro to web design.</a></p>
			</div>
		   </section>
		</div>
		</body>
